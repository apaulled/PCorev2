...
import me.apaulled.pcorev2.hci.project2.VaultGui;
import me.apaulled.pcorev2.hci.project2.VaultListener;
import me.apaulled.pcorev2.hci.project2.VaultBlockListener;
...
public final class PCorev2 extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.getCommand("Phone").setExecutor(new VaultGui());
        ...
        this.getServer().getPluginManager().registerEvents(new VaultBlockListener(), this);
